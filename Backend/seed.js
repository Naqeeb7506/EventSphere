...
const users = [
    ...
    { name: 'Demo User', email: 'user@eventsphere.com', password: 'password123', role: 'user' },
    ...
    { name: 'George Miller', email: 'george@eventsphere.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@eventsphere.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        await mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:3000/eventsphere');
        ...
        const createdEvents = await eventModel.insertMany(eventsWithAdmin);
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@eventsphere.com');
        console.log('User Email:  user@eventsphere.com');
